...
Note: This is a solution for single-vehicle ↔ ground-station communication. If your goal is scalable multi-vehicle missions, using the RFD900x serial radio to move ip packets can serve as an intermediate testing step before moving to network radios (layer 3) like mesh or wifi radios for multiple vehicles.
